...
# Thu Apr 13 17:22:29 CEST 2023
# DO NOT MODIFY


# 
# AvalonMM_hyperRamS27KL0641_interface "AvalonMM_hyperRamS27KL0641_interface" v1.0
# Andrea Bononi 2023.04.13.17:22:29
# IP core to interface a hyperRAM (model S27KL0641) to an Avalon Memory-Mapped bus
# 
...
# 
set_module_property DESCRIPTION "IP core to interface a hyperRAM (model S27KL0641) to an Avalon Memory-Mapped bus"
set_module_property NAME AvalonMM_hyperRamS27KL0641_interface
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Memory Interfaces and Controllers"
set_module_property AUTHOR "Andrea Bononi"
set_module_property DISPLAY_NAME AvalonMM_hyperRamS27KL0641_interface
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL AvalonMM_hyperRamS27KL0641_interface
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE true
add_fileset_file AvalonMM_hyperRamS27KL0641_interface.vhd VHDL PATH AvalonMM_hyperRamS27KL0641_interface.vhd TOP_LEVEL_FILE
...
# 
# connection point hbus
# 
add_interface hbus conduit end
set_interface_property hbus associatedClock clock
set_interface_property hbus associatedReset reset
set_interface_property hbus ENABLED true
set_interface_property hbus EXPORT_OF ""
set_interface_property hbus PORT_NAME_MAP ""
set_interface_property hbus CMSIS_SVD_VARIABLES ""
set_interface_property hbus SVD_ADDRESS_GROUP ""

add_interface_port hbus hbus_d command_address_data Bidir 8
add_interface_port hbus hbus_rwds read_write_data_strobe Bidir 1
add_interface_port hbus hbus_cs chip_select Output 1
add_interface_port hbus hbus_rst reset Output 1
add_interface_port hbus hbus_ck clock Output 1
